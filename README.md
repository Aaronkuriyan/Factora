...
### Backend
- **Framework**: Node.js (Express) / Python (Flask/FastAPI)
...
- **MongoDB** or **PostgreSQL** - [Download](https://www.mongodb.com/) / [Download](https://www.postgresql.org/)
...
```bash
git clone https://github.com/Aaronkuriyan/fake-news-detector.git
